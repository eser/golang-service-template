...
//	insert into "channel" (id, name)
//	values ($1, $2) returning id, name
func (q *Queries) CreateChannel(ctx context.Context, arg CreateChannelParams) (*channel.Channel, error) {
	row := q.db.QueryRowContext(ctx, createChannel, arg.Id, arg.Name)
	var i channel.Channel
...
//	select id, name from "channel"
//	where id = $1
func (q *Queries) GetChannelById(ctx context.Context, id string) (*channel.Channel, error) {
...
//	select id, name from "channel"
//	where name = $1
func (q *Queries) GetChannelByName(ctx context.Context, name sql.NullString) (*channel.Channel, error) {
...
//
//	select id, name from "channel"
func (q *Queries) ListChannels(ctx context.Context) ([]*channel.Channel, error) {
